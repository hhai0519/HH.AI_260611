...
**来源**：[国会议员致SEC資訊函](https://casten.house.gov/imo/media/doc/letter_to_sec_on_justin_sun_september_2025.pdf) / [Blumenthal参议员声明](https://www.blumenthal.senate.gov/newsroom/press/release/blumenthal-demands-answers-from-sec-chairman-over-preferential-treatment-of-trump-crypto-backers)
**可資訊度**：★★★★（国会官方文件）

多名民主党议员对SEC撤诉提出质疑：
- 孙宇晨在特朗普上任前投资了至少7500万美元购买World Liberty Financial（特朗普家族加密專案）代币
- 随后SEC在特朗普政府下撤销了对他的起诉
- 议员称这「可能是pay-to-play方案的一部分」
- 众议员Sean Casten和参议员Jeff Merkley联合致資訊SEC，要求对此进行全面监督
...
**可資訊度**：★★★★（独立调查记者，CoinDesk前编辑，大量引用一手资料）

这是目前对孙宇晨最系统性的英文深度报道之一，核心发现：

1. **TRX代币集中度**：孙宇晨拥有TRX总供应量的63%。他起诉Bloomberg试图阻止这一資訊被披露
2. **与SBF/FTX的结构性相似**：如同SBF的FTX/Alameda靠自己创造的FTT代币支撑，孙宇晨的财富本质上依赖于他自己控制的TRX代币
3. **Tesla赠送抽奖作弊**：Tron团队使用链上工具进行抽奖，留下了清晰的链上记录——孙宇晨运行了88次抽奖程式，直到得到他想要的结果
...
梳理的争议清单：白皮书抄袭、Tesla抽奖、巴菲特午餐、肾结石取消（实为被禁出境）、被删除的道歉資訊。
...
CZ与孙宇晨保持距离。当孙宇晨邀请CZ参加巴菲特午餐时，CZ迅速确认不会出席，并推荐了Anthony Pompliano替代。这种「礼貌拒绝」本身传达了資訊号。
...
- 表示愿意「全面配合SEC调查，提交所有相关微資訊聊天记录」及其他由孙宇晨员工提供的证据
...
2019年中国当局调查事件：
- 财新网报道：孙宇晨并非因肾结石取消巴菲特午餐，而是被北京网資訊办禁止出境
- 涉嫌调查方向：非法集资、洗钱、色情分发、赌博
- 孙宇晨随后发布了一封赞美中国社会主义的道歉資訊，后将其删除
...
TRON低手续费和高吞吐量的特性使其成为稳定币转账的实用选择。这不是营销话术，而是由链上資料和实际使用量支撑的事实。问题不在于TRON是否有用，而在于创始人的行为是否与这种实用价值相匹配。
...
### 巴菲特午餐（2019）
- 以456.7万美元拍下巴菲特慈善午餐
- 以「肾结石」为由取消，实际被财新网揭露为被中国网資訊办禁止出境
- 最终于2020年1月低调完成午餐
