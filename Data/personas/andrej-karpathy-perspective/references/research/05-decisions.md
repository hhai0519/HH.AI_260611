...
> 调研时间：2026-04-05
> 資訊来源：Wikipedia、TechCrunch、CNBC、Lex Fridman Podcast、Karpathy本人Twitter/X、BDTechTalks、VentureBeat、Electrek等
...
### 决策逻辑
这是一个典型的「可验证性驱动」决策。Tesla 拥有百万辆车的真实資料飞轮，恰好是验证「神经网络替代人工编写规则」范式的最大实验场。从学术研究转向现实验证，符合他「如果我建不出来，我就不算真正理解了」的认识论。
...
**核心论点一：資料飞轮比传感器方案更重要**
「真正的问题不是你有没有 LiDAR，而是你有没有一支能收集資料的车队。」
...
### 言行一致性分析
Karpathy 离开 Tesla 后未公开反驳这一技术路线。他的技术判断在某种程度上被市场验证：Tesla FSD 持续迭代，仍是纯视觉路线。但 Waymo 等公司的多传感器方案在安全性資料上的表现也引发了持续争论。
...
### 影响
nanoGPT 成为 AI 教育领域被阅读量最大的代码之一，成为后续众多專案的基准和起点。

---

## 决策六：重返 OpenAI（2023年2月）

在「空档期」密集发布了大量教育内容后，GPT-4 发布前几个月，他选择回到 OpenAI。他主要负责搭建新团队，专注于「中间训练」（midtraining）和合成資料生成，也参与了 GPT-4 的改进工作。
...
**言行一致**：这是他第二次选择「个人專案」优先于「大公司」。模式非常稳定——他在大公司待一段时间，做贡献，然后回归自主创作状态。
...
2026年3月，他用 vibe coding 做了一个劳动力市场 AI 暴露度分析图，被误读后删帖，解释是「被严重误读了，这是一个周六早上的两小时專案」。
...
### 言行存疑
- 「vibe coding」描述与他「构建式理解」的核心資訊条之间的张力，他没有在公开场合充分解释这两者如何共存
