...
- SW2.0：給定輸入-輸出對，最佳化演算法在"程式空間"中搜索最優程式（網路權重）
...
**SW2.0 將吃掉的領域**：視覺識別、語音處理、影像翻譯、影像描述、遊戲AI、資料庫查詢
...
| 年份 | 標題 | 發表場合 | 合作者 | 核心貢獻 |
|------|------|---------|--------|---------|
| 2017 | Deep Visual-Semantic Alignments for Generating Image Descriptions | IEEE TPAMI | Li Fei-Fei | 多模態對齊（影像→自然語言描述） |
| 2016 | **DenseCap**: Fully Convolutional Localization Networks for Dense Captioning | CVPR | Justin Johnson, Li Fei-Fei | 密集影像描述任務 |
...
| 2015 | Deep visual-semantic alignments for generating image descriptions | CVPR | Li Fei-Fei | 影像描述早期版本 |
...
### 論點3：軟體正在經歷根本性範式轉變（SW1.0→2.0→3.0） ★★★★★
...
- 2025 LLM Year in Review中：將RLVR（Reinforcement Learning from Verifiable Rewards）稱為2025年最重要的訓練範式轉變，高度讚揚
