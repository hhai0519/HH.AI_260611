...
| 个人主页点击 | **24x** | 使用者点进你主页并互动 | 开源代码 |
| 停留时间(>2min) | **20x** | 使用者在你的帖子/对话上停2分钟+ | 开源代码 |
...
- **时间衰减**：每6小时可见性减半
- **Premium必要性**：4x关注者Feed加成 + 2x非关注者Feed加成 + TweepCred即时+100。非Premium发链接帖中位互动为零（2026.03資料）
...
理由：
1. **独特视角**：中国AI生态的一手資訊（DeepSeek、GLM等）对国际受众有独特价值
