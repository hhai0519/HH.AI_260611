...
| **"X is like Y"** | "Startups are as unnatural as skiing" / 程式语言"should be a pencil, not a pen" | 类比说明 |
...
- **限定词的正当使用**："I think"不是软弱，而是精确表达确資訊程度
- **Morris法则**（以友人Robert Morris命名）：只发表自己确資訊的观点，删掉弱句子，放弃不work的分支
...
certainty_spectrum:
  strong_claims: "bold, but true"——确資訊时非常直接
