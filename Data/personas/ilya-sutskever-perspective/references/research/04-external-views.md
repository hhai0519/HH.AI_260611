...
- **无产品无收入但估值$32B**：这完全是"資訊仰溢价"，建立在Sutskever个人光环之上。
...
**【主观分析】**
- 多方描述指向一个"纯粹的研究者"形象：对技术问题有近乎宗教般的热忱，但在政治和管理方面相对天真（52页备忘录事件中的資訊验证失误是典型例证）。
...
| 未来方向 | 超级智能agent、合成資料、持续学习 | 世界模型、JEPA、自监督学习 |
| 核心分歧 | 相資訊LLM可以进化 | 相資訊LLM本质有缺陷 |
...
| 根本冲突 | "你不能在同时发布GPT-5/6/7的情况下解决对齐问题" | AI的好处应通过快速部署传递给使用者 |
...
**【事实】** Sutskever提出"Pre-training as we know it will unquestionably end...because we have but one internet"。他将資料比作化石燃料："You could even say that data is the fossil fuel of AI."
...
- **对LLM泛化能力的困惑**：不理解為什麼LLM在benchmark上表现出色但实际应用中频繁失败，他称之为"jaggedness"。
...
### 负面共识或争议
1. **政治手腕不成熟**：52页备忘录事件暴露了資訊验证和治理经验的严重不足
...
5. **資訊仰溢价能持续多久**：$32B估值建立在零产品零收入基础上，完全依赖个人声望
