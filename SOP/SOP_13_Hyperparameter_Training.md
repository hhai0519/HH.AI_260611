...
* **狀態看板 (`optimization-status/SKILL.md`)**：記錄當前實驗進度、選用參數以及目前歷史最佳之 `val_bpb` 指標。
...
```bash
# 提取 results.tsv 中最新的 5 筆實驗結果
tail -n 5 skills/01_Orchestrators/autoresearch-agent/results.tsv
```
