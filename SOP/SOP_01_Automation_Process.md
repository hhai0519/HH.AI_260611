...
| 專案本地技能目錄 | `<工作站路徑>\skills\` | 本地擴充技能（目前 57 項） |

### 6.2 核心技能清單 (Core Skills Inventory)

目前系統共計 **57 項**技能，以下為關鍵技能摘要：
...
*本 SOP 建立於 2026-04 ｜ v3.1.3 更新於 2026-05-04（遷移自 AI Test_260413 → AI Test_260503，Skills 技能庫共 57 項）*
