...
const { resolveWorkspaceRoot, loadWorkspaceEnv } = require('../../../../../../Modules/shared/workspaceLoader.js');
...
function getDefaultDbPath(): string {
    const dbDir = path.join(WORKSPACE_ROOT, 'Data');
    if (!fs.existsSync(dbDir)) {
        fs.mkdirSync(dbDir, { recursive: true });
    }
    return path.join(dbDir, 'telegram_remoat.db');
}
