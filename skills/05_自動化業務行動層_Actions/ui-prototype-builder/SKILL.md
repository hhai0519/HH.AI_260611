...
| 個人主頁 / AI 導航 / AI 寫作 / SaaS / 開發檔案 | `assets/showcases/website-*/` |
...
**只在動畫產出**（HTML 動畫 → MP4 / GIF）預設帶「**Created by Claude-Design**」水印，輔助 skill 傳播。**幻燈片 / 資訊圖 / 原型 / 網頁等其他場景不加**——加了反而幹擾使用者實際使用。
