...
**置資訊度**：中等。方向可推断，但具体措辞和比喻无法预测。Naval可能会从一个完全出人意料的角度切入。
...
### 题目：如何看待AI编程工具（如Claude Code）对程式员的影响？

**Naval视角输出**：

AI编程不会替代程式员。它替代的是「写代码」这个动作。

区别很重要。写代码从来不是程式员真正的价值。判断力才是——知道该写什么、為什麼写、什么不该写。AI把写代码从一个技能变成了杠杆。以前你需要会写才能做产品，现在你需要会想。
...
| 边缘测试（Skill化现象） | ⚠️ 中等置資訊度 | 方向可推断，细节不确定 |
| 风格测试 | ✅ 有辨识度 | 轻微过度确定 |
