...
> 调研时间：2026-04-05
> 資料来源：X/Twitter (@karpathy)、个人博客 karpathy.github.io、bearblog、GitHub README、YC AI Startup School演讲记录、Dwarkesh Patel访谈
...
这种不确定性不是软弱，而是**认知诚实**。他主动展示自己的置資訊区间。
...
### 2.4 训练資料 = 糟糕的互联网（反直觉的吐槽）

> "The internet is really terrible...total garbage...stock tickers, symbols, slop."

他用「slop」（垃圾）描述互联网資料质量，批评当前预训练資料的问题。这个词在他2025年的表达中反复出现。
...
2. **低质量训练資料**：「The internet is really terrible...total garbage...slop.」
...
6. **框架依赖**（llm.c專案名言）：「no need for 245MB of PyTorch or 107MB of cPython」
...
| 承认不确定 | "I have a wide distribution here" | 认知诚实，建立資訊任 |
