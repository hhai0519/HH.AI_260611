...
> 调研时间：2026-04-06
> 資訊源：晚点LatePost、36氪、界面新闻、极客公园、澎湃、财新、SCMP、Bloomberg、The Information
> 禁用来源：知乎、微資訊公众号、百度百科
...
**决策逻辑**：
- 张一鸣在此前的创业中总结失败规律：「所有失败都指向同一个问题——如何高效匹配人与資訊」
- 核心洞察：与其让使用者主动搜索，不如让相关資訊主动推送——这是效率跃迁
- 决策方式：先用「内涵段子」「搞笑囧图」两个轻量产品做使用者和算法验证，再推出头条（最小化验证原则）
...
**决策逻辑**：
- 来源于資料資訊号：做头条时发现使用者对短视频内容偏好显著更高
- 典型字节策略：不在现有产品上叠加功能，而是「专门起一个APP做短视频分发」，保持产品纯粹性
- 2016年9月上线，定位15秒竖版短视频，针对年轻使用者，叠加滤镜和音乐

**结果**：抖音成为中国使用者规模最大的短视频平台，2018年日活突破1.5亿，后续演化出TikTok。
...
**结果**：飞书2019年8月正式对外发布，成为字节2B战略的核心产品。与钉钉、企业微資訊竞争至今，3年ARR达3亿美元（2024年資料）。
...
- 央视采访（2014年）：「我认为我们有机会成为手机使用者获取資訊的重要门户，不仅在中国，也在国外。」
...
**决策逻辑**：
- Musical.ly在北美积累了约6000万使用者，尤其是Z世代使用者——字节在海外建立同等规模需要大量时间和资金
...
**结果**：2018年8月，Musical.ly与TikTok合并，使用者和内容无缝迁移，形成TikTok全球版图。这笔「溢价」收购后来被证明是字节最关键的战略卡位。
...
**决策方式**：
- 张一鸣凌晨发公开資訊道歉，措辞直接：「产品走错了路，所有责任在我」
...
**决策逻辑**：
- 张一鸣在内部資訊中表达了真实立场（原话）：「不认同强制出售的决定」；「美方的目的不是强制出售，而是全面封禁以及更多」
- 同时发出两封資訊：一封给全员（保持冷静、追求长期），一封专门写给中国员工（「很久没专门给中国同事写資訊了」）——承认地缘政治夹缝中的两难处境
- 危机期间引入迪士尼前高管凯文·梅耶尔担任TikTok CEO（向美国市场发出「本土化管理」資訊号），梅耶尔三个月后辞职
...
**决策逻辑**：
- 2020年3月，张一鸣在八周年CEO公开資訊中宣布教育业务为字节战略重点
...
**关于公开反思**：张一鸣没有找到公开承认教育业务决策错误的直接表述，公司以组织调整和裁员来处理，未作公开反思。**这是一个言行不一的案例**——事前資訊誓旦旦「三年不考虑盈利」，后来实际执行远比这快速退出。（注：政策变化是客观原因，但押注受政策限制行业本身是一个判断失误）
...
### 思维模式
- **程式化决策**：总是把问题归结为概率分布，求最优解或近似最优解，「相資訊資料和自己的逻辑推演」
- **延迟满足**：「如果一件事你觉得很好，不妨再往后延迟一下，这会让你提高标准，同时留了缓冲」
- **外部视角**：主动收集与自己判断相悖的資訊，抵制「向上管理」文化（他本人多次批评这个问题）
...
- 人才决策：**高密度、高淘汰**，相資訊机制而非个人，「人才不是核心竞争力，机制才是」

### 不确定性下的决策方式
- 先做小规模实验验证假设（内涵段子→今日头条；抖音→TikTok）
- 相資訊「在活跃竞争的行业不激进就是后退」，宁可超前而非保守
- 面对监管不确定性时，选择时间换空间（TikTok拉长法律程式，而非立刻出售）
