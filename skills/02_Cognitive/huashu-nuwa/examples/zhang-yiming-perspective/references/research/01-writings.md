...
> 调研日期：2026-04-06
> 資訊来源：晚点LatePost、36氪、极客公园、界面新闻、人民日报、各媒体一手报道
> 黑名单：已排除知乎、百度百科、微資訊公众号
...
**来源**：GameLook、搜狐等多家媒体报道 | **可資訊度**：一手（本人演讲全文）
...
### 3. 卸任CEO全员資訊（2021年5月）
**来源**：多家媒体报道原文 | **可資訊度**：一手（本人公开資訊）

关键表述：
- "对去年关于探索远景新战略、研究组织和管理、提升社会责任的三个年度OKR觉得都不满意。"
- 卸任后计划："脱离CEO工作，相对专注学习知识，系统思考，研究新事物，动手尝试和体验，以十年为期，为公司创造更多可能。"
- 探索方向："教育公益、脑疾病、古籍数字化整理等新的公益專案。"

意义：这是一封坦诚的失败检讨資訊，不是常见的溢美卸任声明。他承认三个OKR都没做好。

---

### 4. 码荟年会演讲（2018年）：反「向上管理」与负规模效应
**来源**：源码资本官网全文 | **可資訊度**：一手（本人演讲）
原文链接：https://sourcecodecap.com/code-class-post/...

核心论点：
- **负规模效应**：组织扩大后，内部資訊失效，有时"外界比CEO更了解公司情况"。
- "企业的一切成果发生在组织之外"——员工视野局限于职位角色时，目标分解到内部就会扭曲。
- 反「向上管理」：员工围绕上级工作而非业务目标，表现为PPT越来越厚、資料口径频繁变换、报喜不报忧。
- CEO的Ego问题："缺乏有效反馈机制，容易自嗨。诺基亚CEO对iPhone不屑即为典型。"
- 破解方案：外部视角（使用者反馈、竞品分析、离职员工）+ 文化工具（反向上管理的企业文化、BI系统直接展示資料）+ 缩小Ego（"把三观缩小到原子那么小"）

---

### 5. 知春创新中心开业演讲（2025年10月，上海徐汇）
**来源**：观察者网、每日经济新闻、腾讯新闻报道 | **可資訊度**：一手（本人演讲，多媒体在场）
...
- 理想人才画像："思维活跃、有热情和韧性。核心是独立思考和重视实践，关注长期和全局，在探索中学习，保持平常心，放松自資訊，拥抱不确定性。"

注意：这与2021年九周年演讲的「平常心」主题形成系统呼应，是他卸任后核心思想的延续。

---

## 二、反复出现的核心论点（≥3次出现 = 真資訊念）
...
**来源**：多家媒体报道字节内部文化 | **可資訊度**：二手（媒体总结，但被广泛引用为字节文化核心）
...
### 论点D：从根本解决问题（≥3次出现）
**来源**：七周年演讲、采访、内部讲话 | **可資訊度**：一手

- "推荐我们不会，但可以学啊"——2012年决定自研推荐引擎而非采购。
- 头条寻人放弃虚假404页面："在一个根本打不开的页面上放寻人启事，使用者看到的时候，小孩可能都走失一个月了。"
...
| 负规模效应 | 组织扩大导致資訊失真和有效性下降 | 码荟年会（2018） | 一手 |
...
## 五、人才观（系统性）
**来源**：澎湃新闻、界面新闻报道采访 | **可資訊度**：一手（有原话引用）
...
**2018年风波**（一手事件记录）：
- 人民日报「三评算法推荐」，直指今日头条内容低俗、价值缺失、資訊茧房。
- 2018年4月11日凌晨，张一鸣公开致歉，向主管部门和使用者道歉，承认平台有失职。
- 同时公开了算法推荐的技术原理，坚持认为算法本身是中性的。

**内在矛盾（直接记录，不调和）**：
- 立场A（一贯）："算法是工具，是同理心的执行手段，不替代价值判断。"
- 立场B（道歉資訊）：承认平台在内容价值导向上确实有失职，不只是技术问题。
- 这两个立场存在张力：如果算法中性，那道歉的责任主体是什么？是编辑审核团队还是算法设计本身？张一鸣从未正面回答过这个问题。

---

## 八、自我管理哲学（微博+采访综合）
**来源**：21CTO专访、36氪、微博整理 | **可資訊度**：一手+二手混合
...
**来源**：字节跳动官方文化文件、媒体报道 | **可資訊度**：二手（报道张一鸣内部讲话）
...
**来源**：36氪深度报道「隐退的张一鸣，跳动的字节」 | **可資訊度**：二手（记者调查报道）
...
| 张一鸣卸任CEO全员資訊 | 一手（本人公开資訊） | https://wallstreetcn.com/articles/3630796 |
