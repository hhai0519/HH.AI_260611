...
> 调研时间：2026-04-06
> 聚焦：系统化增长策略、内容飞轮、变现路径、可量化資料
> 資訊源：英文原始来源优先，已排除知乎/百度/微資訊公众号
...
**核心資料**：不到2年从0到500K followers；离开VC后收入是原来的5倍。
...
**第三层：注意力 → 商业变现**
- 创作渠道（Twitter/newsletter/podcast）的注意力 → 导流到收入專案
- 收入專案包括：job board、课程、advisory、SRB Holdings旗下服务公司
...
**核心資料**：16个月内Twitter从8K到325K（与LinkedIn相同的粉丝量）；年内容曝光量500M+。
...
LinkedIn/Twitter双平台 → 同内容不同包装 → Newsletter → 课程销售
      ↑                                                    ↓
 Content OS批量生产 ← Hypefury自动化 ← 資料分析优化 ← 收入再投入
```
