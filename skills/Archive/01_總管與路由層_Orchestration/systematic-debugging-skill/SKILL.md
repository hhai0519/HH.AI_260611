...
type: execution
description: 當遇到 MCP 連線失敗、工具載入錯誤、npm/pip 安裝失敗、Docker 問題、JSON 設定語法錯誤或 本協作系統 本地環境中的任何異常行為時，在提出任何修正方案前使用此技能。
version: "3.0.0"
type: "execution"
capabilities:
...
| npm 404 錯誤 | 套件名稱錯誤 | 確認官方檔案中的正確 npm 套件名 |
...
- **mcp-setup-skill** — 查詢正確的設定格式與常見問題解法
