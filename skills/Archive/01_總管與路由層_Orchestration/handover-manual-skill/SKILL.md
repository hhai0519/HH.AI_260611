...
本技能生成**標準化的專案交接檔案**，確保在 Session 切換、人員交接或長期專案暫停後，任何繼任者（包含 AI Agent 本身）都能立即掌握全域性、無縫接手，零資訊損失。
...
> [!WARNING]
> **已知問題**：舊 DLP 指令碼（fix_dlp.js）若再次執行將導致內容覆蓋，已永久廢棄。
